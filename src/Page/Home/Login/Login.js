...
const Login = () => {
  return (
    <div className="bg-base-300  px-5 py-12 mx-auto">
      <div class="w-full max-w-sm p-6 m-auto mx-auto bg-base-100 rounded-md shadow-md dark:bg-gray-800">
        <h1 class="text-3xl font-semibold text-center text-rose-700 dark:text-white">
          3D WORLD ENGINEERING LOGIN
        </h1>
